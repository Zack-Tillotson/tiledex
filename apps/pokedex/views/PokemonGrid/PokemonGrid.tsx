...
import { PokemonGrid as PokemonGridUI } from '@repo/ui/pokemon-grid/pokemon-grid';
...
export function PokemonGrid({ startIndex = 1, endIndex = 50, initialFilters = {} }: PokemonGridProps) {
  ...
  useEffect(() => {
    ...
    filteredPokemon = filteredPokemon.slice(adjustedStartIndex, adjustedEndIndex);
