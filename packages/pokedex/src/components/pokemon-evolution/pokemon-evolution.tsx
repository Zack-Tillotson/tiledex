...
export function PokemonEvolution({
  ...
  if (!evolution || evolution.length === 0) {
    return (
      <div className={styles.noEvolution}>This Pokémon does not evolve.</div>
    );
  }
      ...
      <div className={styles.evolutionChain}>
        {evolution.map((node, index) => {
          ...
          const isCurrentPokemon =
            pokemonData.name.toLowerCase() === currentPokemonName.toLowerCase();
          ...
          const evolutionItem = (
            ...
            >
              ...
              <div className={styles.evolutionId}>
