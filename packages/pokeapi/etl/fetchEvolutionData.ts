 ...
 */
async function fetchEvolutionChain(id: number): Promise<EvolutionChainResponse | null> {
  try {
...
async function fetchAllEvolutionChains(): Promise<void> {
  console.log(`Starting to fetch data for Evolution Chains from ID ${rangeStart} to ${rangeEnd}...`);
